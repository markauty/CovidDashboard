...
def Download_Latest_Cases_To_File(datestr):
    ...
    try:
        ...
        print(" /home/markaut/mysite/dailyreports/"+datestr+".csv")
        df3.to_csv('dailyreports/'+datestr+".csv", index=False)
        #df3.to_csv('dailyreports/goose22.csv', index=False)
        return datestr+".csv"
    except:
        return 'Problem'
...
def Create_Incidence_Dataframes(incidencelog,file_list):
    try:
        ...
        pass
    incidencelog['2020']=incidencelog['2020']*1000

    #file_list=['20200320','20200321','20200322','20200323','20200324']

    #print(file_list)
    for files in file_list:
        datefile=pd.read_csv('dailyreports/'+files+".csv")
