...
app.layout = html.Div([
    dcc.Interval(
            ...
            interval=1*1000*60*60, # in milliseconds  every day
            n_intervals=0
        ),
    ...
    dcc.Link('Daily infection count', href='https://www.arcgis.com/home/item.html?id=b684319181f94875a6879bbc833ca3a6#overview '),
    html.Label(' and '),
    dcc.Link('Population data', href='https://www.ons.gov.uk/file?uri=%2fpeoplepopulationandcommunity%2fpopulationandmigration%2fpopulationprojections%2fdatasets%2flocalauthoritiesinenglandtable2%2f2016based/table2.xls'),
    html.Label(' respectively.'),
    html.P('Charts report percentage infections for each area.'),
    html.P(''),
    html.Label('Source code can be found at '),
    dcc.Link('https://github.com/markauty/CovidDashboard', href='https://github.com/markauty/CovidDashboard'),
    ]),
])
